                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            >
                                <div>
                                    <div
                                        className="h-16 w-16 bg-purple-100 dark:bg-purple-800/20 flex items-center justify-center rounded-full">
                                        <svg
                            ...
                            >
                                <div>
                                    <div className="h-16 w-16 bg-purple-100 dark:bg-purple-800/20 flex items-center justify-center rounded-full">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
